(function () {
  ...
  function renderDraftPositional() {
    ...
    chipGrid.style.width = `${chartWidth}px`;
    chipGrid.style.maxWidth = `${chartWidth}px`;
    chipGrid.style.marginLeft = `${margin.left}px`;
    chipGrid.style.marginRight = `${margin.right}px`;
